...
<div class="modal fade" id="modal" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered modal-xl" id="modaldialog">
        <!--begin::Modal content-->
        <div class="modal-content rounded">
            ...
            <!--end::Modal header-->
            <!--begin::Modal body-->
            <div class="modal-body pt-0 pb-15 px-5 px-xl-20" id="modalbody">
                <!--begin::Heading-->
                <div class="mb-13 text-center">
                    <h1 class="mb-3" id="modaltitle">Modal Title</h1>
                </div>
                <!--end::Heading-->
                <!--begin::Actions-->
                <div class="d-flex flex-center flex-row-fluid pt-12" id="modalfooter">
